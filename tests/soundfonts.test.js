/**
 * Tests for the GM soundfont loading path: how many samples a strategy asks
 * for, and which CDN they come from.
 *
...
} from "../src/utils/gm-instruments.js";
...
test("all 128 GM programs are mapped", async () => {
  const { GM_INSTRUMENTS } = await import("../src/utils/gm-instruments.js");
